...
- Автоматическая привязка к персонам: новые лица, добавленные в существующие кластеры, автоматически относятся к персоне через JOIN (без создания избыточных face_labels)
