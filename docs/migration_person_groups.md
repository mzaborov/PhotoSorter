...
- 2026-01-XX - Исправлена проблема с SQL зарезервированным словом `group` (использованы кавычки)
- 2026-01-XX - Создан и протестирован скрипт массового назначения групп (`assign_person_groups.py`)
- 2026-01-XX - Исправлена ошибка кодировки в скрипте (заменена стрелка → на ->)
